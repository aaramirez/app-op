...
Finalmente, se calcula la distancia entre cada retorno de una misma serie y se colocan en pares para dibujar la serie bivariada. Luego se dibuja gráfico de los pares.
